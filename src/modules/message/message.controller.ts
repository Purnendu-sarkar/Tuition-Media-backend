...
async function getMyConversations(req: Request, res: Response, next: NextFunction) {
  try {
...
async function getConversation(req: Request, res: Response, next: NextFunction) {
  try {
    const userId = req.user!.sub;
...
async function initiateConversation(req: Request, res: Response, next: NextFunction) {
  try {
    const userId = req.user!.sub;
