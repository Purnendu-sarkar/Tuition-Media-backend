...
async function getDashboardStats(guardianId: string) {
...
async function createJob(guardianId: string, payload: CreateJobInput) {
...
async function getJobApplications(guardianId: string, jobId: string) {
  ...
  const applicationsWithScore = applications.map(app => {
    const matchScore = aiService.calculateMatchScore(
...
async function updateApplicationStatus(guardianId: string, applicationId: string, data: UpdateApplicationInput) {
...
async function getAllJobs(guardianId: string) {
